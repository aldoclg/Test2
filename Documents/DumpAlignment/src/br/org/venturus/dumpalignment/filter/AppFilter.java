package br.org.venturus.dumpalignment.filter;
 ...
 */
@WebFilter("/AppFilter")
public class AppFilter implements Serializable, Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {		
		...
		if (isloggedIn == null) {	
			...
			((HttpServletResponse) response).sendRedirect(contextPath + "/logout.xhtml"); 
        } else if (!isloggedIn) {
        	((HttpServletResponse) response).sendRedirect(contextPath + "/logout.xhtml");         
		} else {
